  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="text-xs leading-relaxed text-[#536078] sm:text-sm">
          {text}
        </p>
      </div>
    </div>
...
function WorkflowBenefit({
  ...
  return (
    <div className="flex items-center gap-2 rounded-full border border-[#DCEEEE] bg-white px-3.5 py-2 text-xs shadow-sm sm:text-sm">
    ...
    >
      <div className="mx-auto max-w-7xl">
        <div className="mb-12 text-center sm:mb-16">
          ...
          <h2 className="mb-3 text-2xl font-extrabold tracking-tight text-[#171717] sm:mb-4 sm:text-4xl lg:text-5xl">
            Tu medicamento en solo 5 pasos
          </h2>

          <p className="mx-auto max-w-xl text-sm text-[#536078] sm:text-base">
        ...
        <div className="grid grid-cols-1 items-center gap-8 sm:gap-12 lg:grid-cols-2">
          ...
          <div className="flex justify-center">
            <div className="w-full max-w-xs rounded-3xl border border-[#DCEEEE] bg-white p-5 shadow-xl sm:max-w-sm sm:p-8">
              <div className="mb-5 text-center text-lg font-bold text-[#171717] sm:mb-6 sm:text-xl">
                FarmaSync
              </div>

              <div className="mb-3.5 flex items-center gap-3 rounded-xl bg-[#EAF8F7] p-3.5 sm:mb-4 sm:p-4">
                <Search
                  size={18}
              ...
              <div className="mb-3.5 rounded-xl border border-[#DCEEEE] p-3.5 sm:mb-4 sm:p-4">
              ...
              <div className="rounded-xl border border-[#DCEEEE] p-3.5 sm:p-4">
                <h4 className="text-sm font-bold sm:text-base">
                  Reserva creada
                </h4>
