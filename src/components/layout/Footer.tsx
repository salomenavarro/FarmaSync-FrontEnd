...
export default function Footer() {
  return (
    <footer
      id="footer"
      className="border-t border-[#DCEEEE] bg-[#e8f0ec] px-4 pb-8 pt-12 sm:px-6 sm:pt-16 lg:px-8"
    >
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 text-center sm:grid-cols-2 sm:text-left lg:grid-cols-4">
        ...
        <div>
          ...
          <div className="mt-5 rounded-xl border border-[#DCEEEE] bg-[#F4FBFA] p-3.5 text-center sm:mt-6 sm:p-4 sm:text-left">
      ...
      {/* COPYRIGHT */}
      <div className="mx-auto mt-10 max-w-7xl border-t border-[#DCEEEE] pt-6 text-center text-xs text-[#6B7280] sm:mt-12">
