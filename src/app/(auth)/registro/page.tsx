  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#FCFBDC] p-6">
      ...
      <div className="relative z-10 flex w-full max-w-4xl overflow-hidden rounded-3xl bg-[#00A8A8]/10 p-4 backdrop-blur-md md:p-8 border border-[#00A8A8]/20 shadow-xl">
        ...
        {/* COLUMNA DERECHA - TARJETA DE REGISTRO (Mismo tamaño que Login) */}
        <div className="w-full shrink-0 max-h-[85vh] overflow-y-auto rounded-2xl border-2 border-[#00A8A8]/30 bg-gradient-to-b from-white via-white to-[#00A8A8]/10 p-8 shadow-2xl backdrop-blur-xl md:w-[420px] scrollbar-thin scrollbar-thumb-[#00A8A8]/30">
          ...
          <form className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full rounded-xl bg-[#00A8A8] py-3.5 text-sm font-bold text-white shadow-lg shadow-[#00A8A8]/30 transition-all hover:bg-[#008C8C] hover:shadow-xl active:scale-[0.98] mt-2"
            >
              CREAR CUENTA
            </button>
          </form>
